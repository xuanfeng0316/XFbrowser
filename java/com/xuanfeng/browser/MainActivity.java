...
public class MainActivity extends Activity {
    ...
    private Button btnBack, btnForward, btnRefresh, btnDesktop, btnSettings;  // 删掉 btnMenu，加上 btnDesktop
    ...
    private void initViews() {
   	 ...
   	 btnDesktop = findViewById(R.id.btn_desktop);  // 改这里
   	 btnSettings = findViewById(R.id.btn_settings); // 改这里
